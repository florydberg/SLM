...
# def weights(w,target, w_prev, std_int): # This weight function works only for discrete tweezers
...
#     plt.imshow(target, cmap='gray')  # Display intensity image
#     plt.scatter(coordinates[:, 1], coordinates[:, 0], c='red', marker='x', s=100, label="Detected Peaks")  # Overlay peaks

#     # Labels & formatting
#     plt.title("Detected Peaks (25)")
#     plt.xlabel("X pixels")
#     plt.ylabel("Y pixels")
#     plt.legend()
...
#     plt.colorbar(label="Intensity")
#     plt.legend()
#     plt.title("Detected Tweezer Positions in CCD Image")
#     plt.show()
